	...
	<table width='99%' height="100%" border='0' cellspacing='0' cellpadding='0'>
	  <tr>
	    <td style='padding-left:3px;padding-top:8px' valign="top">
	      ...
	      <dl class='bitem'>
	        <dt onClick='showHide("items1_1")'><b>合同信息管理</b></dt>
	        <dd style='display:block' class='sitem' id='items1_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/hetong?type=hetongMana' target='main'>合同信息管理</a> </li>
	            <li><a href='<%=path %>/admin/hetong/hetongAdd.jsp' target='main'>合同信息录入</a> </li>
	            <li><a href='<%=path %>/admin/hetong/hetongSea.jsp' target='main'>合同信息查询</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <dl class='bitem'>
	        <dt onClick='showHide("items1_1")'><b>收款提醒模块</b></dt>
	        <dd style='display:block' class='sitem' id='items1_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/admin/tixing/tixingAdd.jsp' target='main'>添加收款提醒</a> </li>
	            <li><a href='<%=path %>/tixing?type=tixingMana' target='main'>收款提醒管理</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <dl class='bitem'>
